  ...
  <div class="columns is-mobile is-vcentered">
    ...
    <div class="column has-text-left mx-5">
      <p class="mb-2">
        ...
        <a href="https://instagram.com" target="_blank" class="icon is-medium mx-1">
          <i class="fab fa-instagram fa-2x"></i>
        </a>
        <a href="https://facebook.com" target="_blank" class="icon is-medium mx-1">
          <i class="fab fa-facebook-f fa-2x"></i>
        </a>
        <a href="https://www.linkedin.com/in/evaldasdmi/" target="_blank" class="icon is-medium mx-1">
